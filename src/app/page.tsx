...
export default function Home() {
    ...
    useEffect(() => {
        if (isInView) {
            animate('p', { opacity: 1, x: 0 }, { duration: 1.2, ease: 'easeInOut' })
            animate('section', {opacity: 1, x: 0}, {duration: 1.2, ease: 'linear'})
    ...
    return (
        <div className="flex flex-col w-full h-full scroll-y-auto overflow-x-clip">
            ...
            <div className="flex w-full h-[90vh] px-20 py-4 relative" id="intro" ref={scope}>
                {/* bg photo */}
                <motion.div
                ...
                <div
                    className="flex flex-col justify-center h-full relative z-10 w-[80%]"
                >
                    <motion.p
                ...
                <div className="flex flex-col w-[20%] h-full relative z-10 mb-6">
                    ...
                    >
                        <SectionLink title="Intro" sectionId="intro" />
                        <Line />
                        <SectionLink title="Work & Projects" sectionId="work&projects" />
                        <Line />
                        <SectionLink title="Education" sectionId="education" />
                        <Line />
                        <SectionLink title="Skills & Tools" sectionId="skills&tools" />
                    </motion.section>
                    <motion.section
            ...
            <div className="bg-gradient-to-l from-neutral-900 to-zinc-950 w-full h-[200vh] flex justify-center relative">
                <div className="flex flex-col w-full justify-center h-[60vh] items-center space-y-48">
                    ...
                    {/* anchors for scroll */}
                    <div id="work&projects" className="mt-[10%]" />
